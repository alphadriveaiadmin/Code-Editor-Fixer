...
st.set_page_config(page_title="Code Editor Creators", layout="wide")

# Use session state to track which page we're on
...
if st.session_state.page == "home":
    st.title("Select a Code Editor Creator")
    st.write("Choose one of the tools below:")
...
# ---------------- TECHWALL PAGE ----------------
    ...
    if st.button("Generate Trigger"):
        try:
            ...
            # Regex: find 10-digit phone numbers in text or formatted
